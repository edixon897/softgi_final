...
class manejoUsuarios():
    ...
    def registrar(self, registro):
        bsq = f"INSERT INTO `empleados`( `nom_empleado`, `ape_empleado`, `doc_empleado`,`fecha_nacimiento_empleado`, `contacto_empleado`, `email_empleado`,  `ciudad_empleado`, `direccion_empleado`, `rol`, `contrasena`,  `fechahora_registroempleado`) VALUES ('{registro[0]}','{registro[1]}','{registro[2]}','{registro[3]}','{registro[4]}','{registro[5]}','{registro[6]}','{registro[7]}','{registro[8]}','{registro[9]}','{registro[10]}')"
